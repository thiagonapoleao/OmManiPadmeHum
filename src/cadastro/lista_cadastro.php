...
$sql_count = "SELECT count(cpf) FROM formulario";
...
$sql_arry = "SELECT id, data, cpf, nome, sexo, datanasc, cidade, estado FROM formulario order by nome asc";
...
<body style="background-image:  url('../img/index-2.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; ">
    ...
    <div id="interface" style="background-image:  url('../img/index-2.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; margin-top: 20px">

        <div class="container" style="background-color: rgba(215, 215, 215, .3);">
            <from>
                    ...
                    <table width="95%" align="center">
                        <thead>
                            <tr style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                ...
                                <th style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">CPF</th>
                        ...
                        <tbody>
                            <?php while ($cadastro = $stmt_array->fetch(PDO::FETCH_ASSOC)) : ?>
                                <tr style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                    ...
                                    <td style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;"><?php echo $cadastro['cpf'] ?></td>
