                ...
                <div align="center" style="color: rgba(236, 173, 33);">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-2 mb-1">
                            ...
                            <select type="text" name="sexo" id="sexo" class="form-control" required>
                    ...
                    <div class="form-row">
                        <div class="col-sm-2 mb-1">
                            <label for="validationServer15">Passaporte</label>
                            <input type="text" name="passaporte" id="passaporte" class="form-control" required>
                        </div>
                        <div class="col-sm-2 mb-1">
                            <label for="validationServer16">Data</label>
                            <input type="date" name="data" id="data" class="form-control" value="<?php echo $data ?>">
                        </div>
                    </div>
                    <br>
                    <div class="form-row">
                        <button type="submit" class="btn btn-outline-warning" style="color: rgba(236, 173, 33);">Cadastrar</button>
                    </div>
                </div>
            </form>
